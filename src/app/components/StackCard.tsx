        ...
        <AnimatePresence>
          {stack.map((card, index) => (
            ...
            >
              ...
              <p className="text-[12px] mt-5 md:text-[15px] m-2">
                {card.content}
              </p>
              <span className="absolute right-10 bottom-3 md:bottom-10 text-3xl cursor-pointer hover:text-black/30" onClick={() => handleRemove(card.id)}>
                →
              </span>
            </motion.div>
          ))}
