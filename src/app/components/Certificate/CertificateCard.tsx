  ...
  return (
    <div className={`flex flex-col-reverse md:flex-row items-center justify-center gap-5 space-y-4 md:space-y-0 md:space-x-8 mx-2 md:gap-6`}>
      <div className="flex flex-col gap-2 w-full">
        ...
        <p className="text-[12px] w-90 md:text-sm  md:w-50  lg:text-xl lg:w-130">
          {description}
        </p>
        <Link
          onClick={handleViewClick}
          href="#"
          className="underline underline-offset-1 text-blue-500 flex md:justify-end hover:text-gray-500"
        >
          View Image
        </Link>
      {showImage && (
